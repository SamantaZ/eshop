...
if (isset($_POST['product'])) {
    $ProductsController->add($_POST['product']);
}
?>
<main class="main">
    <div class="content">
            ...
            <div class="row">
                <div class="col-12 col-xl-12">
                    <div class="mb-5">
                        ...
                        <input class="form-control" type="text" placeholder="Write SKU here..." id="sku"
                            name="product[sku]" minlength="8" required>
                        <div id="skuHelp" class="form-text">Please provide at least 8 characters.</div>
                        <small class="mb-5" id="skuError"></small>
                    </div>
                    <div class="mb-5">
                        <h4 class="mb-3">Name</h4>
                        <input class="form-control" type="text" placeholder="Write name here..." id="name"
                            name="product[name]" required>
                        <small class=" mb-5" id="nameError"></small>
                    </div>
                    <div class="mb-5">
                        <h4 class="mb-3">Price ($)</h4>
                        <input class="form-control" type="number" step="any" placeholder="Write price here..."
                            id="price" name="product[price]" required>
                            ...
                            <div class="row g-3">
                                <div class="col-12 col-xl-12">
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select mb-3" id="productType" name="product[type_id]"
                                            required>
                                            <option value="">Select product type</option>
                                            <?php foreach ($product_types as $product_type): ?>
                                                <option value="<?= $product_type['producttype_id']; ?>"
                                                    id="<?= $product_type['producttype_name']; ?>">
                                                    <?= $product_type['producttype_name'] == 'Dvd' ? strtoupper($product_type['producttype_name']) : $product_type['producttype_name']; ?>
                                                </option>
                                                <?php endforeach; ?>
                                        </select>
